...
function initializeDefaultData(): void {
  ...
  const defaultTickets = [
    ...
    { id: 4, ticket_no: 'WO20240101004', title: '人事系统登录缓慢', type: 'incident', status: 'processing', priority: 'medium', customer_id: 2, customer_name: '市人社局', project_id: 2, project_name: '人事管理系统', asset_id: 4, reporter_id: 3, assignee_id: 2, assignee_name: '张工', description: '用户反馈人事管理系统登录响应时间超过10秒', resolution: null, due_date: new Date(Date.now() + 172800000).toISOString(), resolved_at: null, closed_at: null, created_at: new Date(Date.now() - 172800000).toISOString(), updated_at: now },
    { id: 5, ticket_no: 'WO20240101005', title: '新系统上线支持申请', type: 'request', status: 'pending', priority: 'low', customer_id: 5, customer_name: '市住建局', project_id: 5, project_name: '房产管理系统', asset_id: null, reporter_id: 2, assignee_id: null, assignee_name: null, description: '房产管理系统即将上线，需要运维支持', resolution: null, due_date: new Date(Date.now() + 604800000).toISOString(), resolved_at: null, closed_at: null, created_at: now, updated_at: now },
  ];
